   ...
   <section class=" sm:mb-150px mb-40px">
      <div class="container">
         <div class="mb-40px lg:mb-0">
            ...
            <h2 class="h2T">Даты проведения</h2>
         </div>
...
const dates = props.student ? [
   ['11 май', ['Встреча с профессионалами', 'Для участников проведут лекцию специалисты в различных областях. ']],
   ['12 май', ['Мастер-класс', 'Участники смогут получить ценные рекомендации.']],
