<template>
   <header class="py-20px absolute w-full sm:(bg-transparent text-base-1) bg-base-1 text-base-2">
      <div class="container" :class="{ 'show-m': showM }">
         <div class="flex justify-between items-center">
            <a href="#" class="text-2xl font-bold uppercase">IT_<span class="text-base-3">Pro</span></a>
            <nav class="">
