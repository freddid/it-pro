               ...
               <div class="relative mb-20px z-0 hover:z-10">
                  <kinesis-container class=" h-200px md:w-auto w-4/5 m-auto">
                     <kinesis-element tag="img" class="w-full rounded-[20px] object-cover h-full" :src="image[0]"
                        :strength="strength" type="depth" />
                     <kinesis-element tag="img" :src="image[1]" :strength="-strength" type="rotate"
                        :transformOrigin="trSize" axis="x"
                        class="-z-2 top-0 left-0 object-cover rounded-[20px] w-full h-full absolute" />
                     <kinesis-element tag="img" :src="image[2]" :strength="strength" type="rotate"
                        :transformOrigin="trSize" axis="x"
